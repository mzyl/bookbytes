...
func BookBuilder(filename string) Book {
  ...
  paragraph := GetParagraph(bookText)
...
func GetParagraph(text []string) (index int) {
...
func NewParagraph() string {
  book.paragraph = GetParagraph(book.bookText)
  return ParagraphPrinter(book)
}
